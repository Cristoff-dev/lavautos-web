                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-800">
                        <tr className="hover:bg-slate-800/30 transition-colors group">
                            <td className="px-6 py-4 font-mono text-cyan-400 font-bold tracking-widest">JABON LIQUIDO</td>
                            <td className="px-6 py-4 text-slate-200">60 LITROS</td>
                            <td className="px-6 py-4">
                                <span className="px-2 py-1 bg-blue-500/10 text-blue-400 rounded-md text-[10px] font-bold">500 BS X LITRO / 1$</span>
                            </td>
                            <td className="px-6 py-4">
                                <span className="px-2 py-1 bg-blue-500/10 text-blue-400 rounded-md text-[10px] font-bold">OTROS</span>
                            </td>
                            <td className="px-6 py-4">
