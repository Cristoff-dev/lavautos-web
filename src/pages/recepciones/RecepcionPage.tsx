            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    <h2 className="text-white text-3xl font-black uppercase italic tracking-tighter">
                        Recepcion y <span className="text-cyan-400">Estados</span>
                    </h2>
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <input type="text" placeholder="nombre del combo.." className="bg-slate-900 border border-slate-800 text-white px-4 py-2 rounded-xl focus:ring-1 focus:ring-cyan-500 outline-none flex-1 md:w-64" />
